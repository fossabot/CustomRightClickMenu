    ...
    (function (Script) {
        ...
        (function (Background) {
            ...
            function createBackgroundPage(node, doDebug) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var isRestart, key, err, indentUnit, _a, _b, backgroundPageCode, libraries, script, greaseMonkeyData, safeNode, code;
                    var _this = this;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 2:
                                _a = _c.sent(), _b = _a[0], backgroundPageCode = _b.code, libraries = _b.libraries, script = _a[1], greaseMonkeyData = _a[2];
                                safeNode = CRMNodes.makeSafe(node);
                                safeNode.permissions = node.permissions;
            ...
            function preprocessUSO(id, stylesheet, options) {
                ...
                while ((match = _variableRegex.exec(stylesheet))) {
                    ...
                    if (!(name_1 in options)) {
                        window.log("Could not find option " + name_1 + " for stylesheet " + id);
                ...
                return new Promise(function (resolve) {
                    window.less.Parser().parse(stylesheet, function (err, result) {
                        if (!err) {
                            ...
                            window.log("An error occurred while compiling less CSS for node " + id + ": " + err.name + " " + err.message);
                            resolve(stylesheet);
                            ;
                        }
                    });
                ...
                return new Promise(function (resolve) {
                    window.stylus(stylesheet).render(function (err, result) {
                        if (!err) {
                            ...
                            window.log("An error occurred while compiling stylus CSS for node " + id + ": " + err.name + " " + err.message);
                            resolve(stylesheet);
                            ;
                        }
                    });
    ...
    function buildPageCRM() {
        ...
        return new Promise(function (resolve) {
            ...
            browserAPI.contextMenus.removeAll().then(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4, CRMNodes.modules.Util.lock(0)];
                        case 1:
                            done = _b.sent();
