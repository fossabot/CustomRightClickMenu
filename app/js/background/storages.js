...
(function (Storages) {
    ...
    (function (SetupHandling) {
        ...
        function handleFirstRun(crm) {
            return __awaiter(this, void 0, void 0, function () {
                var returnObj, _a, defaultLocalStorage, defaultSyncStorage, storageLocal, storageLocalCopy, result;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 1:
                            _a = _b.sent(), defaultLocalStorage = _a[0], defaultSyncStorage = _a[1];
                            browserAPI.storage.local.set(defaultLocalStorage);
                            uploadStorageSyncInitial(defaultSyncStorage);
                            if (crm) {
                                defaultSyncStorage.crm = crm;
                            }
                            storageLocal = defaultLocalStorage;
                            storageLocalCopy = JSON.parse(JSON.stringify(defaultLocalStorage));
                            result = {
...
(function (Storages) {
    ...
    function loadStorages() {
        var _this = this;
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var storageSync, _a, storageLocal, result, data, storageLocalCopy, settingsStorage, indexes, settingsJsonArray_1, indexesLength, jsonString, indexes, settingsJsonArray_2, indexesLength, jsonString, _i, _b, fn, _c, _d, fn;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        window.info('Loading sync storage data');
                        if (!supportsStorageSync()) return [3, 2];
                    ...
                    case 8:
                        ...
                        if (!storageLocal['useStorageSync']) return [3, 12];
                        indexes = storageSync['indexes'];
                        if (!(indexes === -1 || indexes === null || indexes === undefined)) return [3, 10];
                        return [4, browserAPI.storage.local.set({
                                useStorageSync: false
                            })];
                    case 9:
                    ...
                    case 10:
                        ...
                        Storages.modules.Util.createArray(indexesLength).forEach(function (_, index) {
                            settingsJsonArray_1.push(storageSync["section" + index]);
                        });
                    ...
                    case 11: return [3, 15];
                    case 12:
                        if (!!storageLocal['settings']) return [3, 14];
                        return [4, browserAPI.storage.local.set({
                                useStorageSync: true
                            })];
                    case 13:
                        ...
                        indexesLength = typeof indexes === 'number' ?
                            ...
                            indexes.length : 0);
                        Storages.modules.Util.createArray(indexesLength).forEach(function (_, index) {
                            settingsJsonArray_2.push(storageSync["section" + index]);
                        });
                    ...
                    case 15:
                        if (result.type === 'upgradeVersion') {
                            for (_i = 0, _b = result.afterSyncLoad; _i < _b.length; _i++) {
                                fn = _b[_i];
                    ...
                    case 16:
                        _e.sent();
                        if (result.type === 'upgradeVersion') {
                            for (_c = 0, _d = result.afterSync; _c < _d.length; _c++) {
                                fn = _d[_c];
                                fn();
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        isEnabled = _a.sent();
                        Storages.modules.storages.storageLocal.useAsUserstylesInstaller = !isEnabled;
                        browserAPI.storage.local.set({
    ...
    function isFirstTime(storageLocal) {
        return __awaiter(this, void 0, void 0, function () {
            var currentVersion, fns;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, browserAPI.runtime.getManifest()];
                    case 1:
                        currentVersion = (_a.sent()).version;
