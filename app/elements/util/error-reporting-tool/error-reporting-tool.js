...
(function (ErrorReportingToolElement) {
    ...
    var ERT = (function () {
        ...
        ;
        ERT._getDownloadPermission = function (callback) {
            var _this = this;
        ...
        ERT.submitErrorReport = function () {
            return __awaiter(this, void 0, void 0, function () {
                var granted, messageBody, title;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, new Promise(function (resolve) {
                                _this._getDownloadPermission(function (granted) {
                                    resolve(granted);
                                });
                            })];
                        case 1:
                        ...
                        case 2:
                            ...
                            messageBody = 'WRITE MESSAGE HERE\n';
                            title = (this.reportType === 'bug' ? 'Bug: ' : 'Feature: ') + 'TITLE HERE';
