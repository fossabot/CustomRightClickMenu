...
(function (NodeEditBehaviorNamespace) {
    ...
    var NEB = (function () {
        ...
        NEB.checkToggledIconAmount = function (e) {
            ...
            this.async(function () {
                ...
                if (selectedCheckboxes.onContentTypes.filter(function (item) { return item; }).length === 0) {
                    var element = window.app.util.findElementWithTagname(e, 'paper-checkbox');
        ...
        NEB._doTypeChange = function (type) {
            ...
            var paperToast = window.app.$.changedToMenuToast;
            ...
            if (prevType === 'menu') {
                ...
                typeSwitcher.shadowColumns(columnCont_1, false);
                window.app.shadowStart = column.index + 1;
                var listener_1 = function () {
                    reverseMenuTypeChoice(columnCont_1);
                };
                paperToast.addEventListener('click', listener_1);
                paperToast.show();
                setTimeout(function () {
                    paperToast.removeEventListener('click', listener_1);
                }, 10000);
            }
            window.app.upload();
        };
