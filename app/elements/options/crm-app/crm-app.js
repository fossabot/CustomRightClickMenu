...
(function (CRMAppElement) {
    ...
    var CA = (function () {
        ...
        CA._getDisabledReason = function () {
        ...
        CA._setupConsoleInterface = function () {
            ...
            window.getChanges = function () {
                ...
                _this._logCode('');
                var _a = _this._uploading.getChanges(false), hasLocalChanged = _a.hasLocalChanged, haveSettingsChanged = _a.haveSettingsChanged, localChanges = _a.localChanges, settingsChanges = _a.settingsChanges;
                if (!hasLocalChanged) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = "Extension has been updated to version ";
                            return [4, browserAPI.runtime.getManifest()];
                        case 1:
                            _a.text = _b + (_c.sent()).version;
        ...
        CA._uploading = (function () {
            ...
            ;
            CRMAppUploading.getChanges = function (force) {
                var localChanges = [];
                var storageLocal = this._parent().storageLocal;
                var storageLocalCopy = force ? {} : this._parent()._storageLocalCopy;
                var settingsChanges = [];
                var settings = this._parent().settings;
                var settingsCopy = force ? {} : this._parent()._settingsCopy;
                var hasLocalChanged = this._getObjDifferences(storageLocal, storageLocalCopy, localChanges);
                var haveSettingsChanged = this._getObjDifferences(settings, settingsCopy, settingsChanges);
                return {
            ...
            CRMAppUploading.upload = function (force) {
                var _a = this.getChanges(force), hasLocalChanged = _a.hasLocalChanged, haveSettingsChanged = _a.haveSettingsChanged, localChanges = _a.localChanges, settingsChanges = _a.settingsChanges;
        ...
        CA.crm = (function () {
            ...
            CRMAppCRMFunctions.lookup = function (path, returnArray) {
                ...
                return (returnArray ? currentItem.children : currentItem);
            };
            ;
