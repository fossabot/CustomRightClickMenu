...
var TEST_EXTENSION = hasSetting('extension');
            ...
            switch (_j.label) {
                ...
                case 4:
                    unBuilt = _b.apply(_a, [new (_d.apply(_c, [void 0, __assign.apply(void 0, _e.concat([(_f.build = _h + (_j.sent()),
                                    _f.name = browserCapabilities.browserName + " " + (browserCapabilities.browser_version || 'latest'),
                                    _f['browserstack.local'] = !TEST_EXTENSION,
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                _a.sent();
                                _a.label = 4;
                            case 4: return [4, imports_1.wait(500)];
                            case 5:
                                _a.sent();
                                return [4, switchToTestWindow()];
                            case 6:
